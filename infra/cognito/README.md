...
MFA is disabled for the POC; the API does not implement challenge responses.
...
Three synthetic POC accounts were prepared for candidate, company and administrator
